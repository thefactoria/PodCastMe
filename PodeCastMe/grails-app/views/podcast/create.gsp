...
<html dir="ltr" lang="en-US"><head>
    <meta charset="utf-8">
    <title>Ajout Nouveau PodCast</title>
...
<!--Ajout du code -->
	<!--	<a href="#create-podcast" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-podcast" class="content scaffold-create" role="main">
