			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="sujet" title="${message(code: 'contact.sujet.label', default: 'Sujet')}" />
				...
				<g:each in="${contactInstanceList}" status="i" var="contactInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${contactInstance.id}">${fieldValue(bean: contactInstance, field: "sujet")}</g:link></td>
