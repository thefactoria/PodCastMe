		...
		<div id="show-contact" class="content scaffold-show" role="main">
			...
			<ol class="property-list contact">
				...
				<li class="fieldcontain">
					<span id="sujet-label" class="property-label"><g:message code="contact.sujet.label" default="Sujet" /></span>
					
						<span class="property-value" aria-labelledby="sujet-label"><g:fieldValue bean="${contactInstance}" field="sujet"/></span>
