	...
	<body>
		...
		<div id="show-commentaire" class="content scaffold-show" role="main">
			...
			<ol class="property-list commentaire">
				...
				<g:if test="${commentaireInstance?.text}">
				<li class="fieldcontain">
					<span id="text-label" class="property-label"><g:message code="commentaire.text.label" default="Text" /></span>
					
						<span class="property-value" aria-labelledby="text-label"><g:fieldValue bean="${commentaireInstance}" field="text"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${commentaireInstance?.podcast}">
				<li class="fieldcontain">
					<span id="podcast-label" class="property-label"><g:message code="commentaire.podcast.label" default="Podcast" /></span>
					
						<span class="property-value" aria-labelledby="podcast-label"><g:link controller="podcast" action="show" id="${commentaireInstance?.podcast?.id}">${commentaireInstance?.podcast?.encodeAsHTML()}</g:link></span>
