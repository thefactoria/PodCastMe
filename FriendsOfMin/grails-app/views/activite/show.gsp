	...
	<body>
		...
		<div id="show-activite" class="content scaffold-show" role="main">
			...
			<ol class="property-list activite">
				...
				<g:if test="${activiteInstance?.desc}">
				<li class="fieldcontain">
					<span id="desc-label" class="property-label"><g:message code="activite.desc.label" default="Desc" /></span>
					
						<span class="property-value" aria-labelledby="desc-label"><g:fieldValue bean="${activiteInstance}" field="desc"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${activiteInstance?.m}">
				<li class="fieldcontain">
					<span id="m-label" class="property-label"><g:message code="activite.m.label" default="M" /></span>
					
						<span class="property-value" aria-labelledby="m-label"><g:link controller="membre" action="show" id="${activiteInstance?.m?.id}">${activiteInstance?.m?.encodeAsHTML()}</g:link></span>
